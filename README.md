...
The prescriptions given below are an essential part of the package. They show how to write database utility functions at scale, how to employ them in the context of transactions, and moreover they outline what needs to be done in order to guarantee the success of migrations.
